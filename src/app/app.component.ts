...
export class AppComponent {
  ...
  breedArray: DogBreed[] = [
      ...
      new DogBreed("Cavlier King Charles Spaniel", "small", "gentle", 13, 8)
  ];
   postArray: Post[] = [
       ...
       new Post("<span class='farts'>Farts</span> too much", "Keely Glenn", "I love my dog so much, but he <span class='farts'>farts</span> way too much. He is so proud of his <span class='farts'>farts</span> that I feel bad not enjoying them, but they just smell so much. What a dilemma!")
   ];
}
